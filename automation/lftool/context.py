...
JS_SOURCES = [
    ...
    "little-fighters-js/renderer/src/rounds.js",
    "little-fighters-js/renderer/src/impact-timing.js",
    "little-fighters-js/renderer/src/audio.js",
    "little-fighters-js/renderer/src/menu.js",
